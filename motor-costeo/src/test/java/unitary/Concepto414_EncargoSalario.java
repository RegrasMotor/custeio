...
public class Concepto414_EncargoSalario extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/environmentVars/p_encargo_13sal.gdst;" +
											...
											"rules/costeo/BRA/Concepto 414 - Encargo de Salario.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 414 no evaluado");
