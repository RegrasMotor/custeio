...
public class Concepto516_TransportePersonal extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/nivelCosteo.drl;" + 
											"rules/costeo/BRA/Concepto 516 - Transporte de personal.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 516 no evaluado");
