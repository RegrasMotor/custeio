...
public class Concepto530_CestaBasica extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/environmentVars/p_cestabasica.gdst;" +
											"rules/costeo/BRA/nivelCosteo.drl;" + 
											"rules/costeo/BRA/Concepto 530 - Cesta basica.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 530 no evaluado");
