...
public class Concepto418_Processos extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/environmentVars/p_processo.gdst;" +										
											"rules/costeo/BRA/nivelCosteo.drl;" + 
											"rules/costeo/BRA/Concepto 418 - Processos.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 418 no evaluado");
