...
public class Concepto110_salarioBase extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/Concepto 110 - Salario base.drl";
    ...
    public void comprobarAccion() {
		...
		for (DetalleCosteo detalleCosteo : detallesCosteo) {
			if (detalleCosteo.getCodigoConcepto()==110) {
