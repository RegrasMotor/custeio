...
public class Concepto515_DescuentoValeTransporte extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/environmentVars/p_des_vtra.gdst;" +
											"rules/costeo/BRA/nivelCosteo.drl;" + 
											"rules/costeo/BRA/Concepto 515 - Descuento vale transporte.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 515 no evaluado");
