...
public class Concepto410_SeguridadSocial extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/environmentVars/p_inss.gdst;" +
											"rules/costeo/BRA/environmentVars/p_rvida_encargo.gdst;" +
											"rules/costeo/BRA/nivelCosteo.drl;" + 
											"rules/costeo/BRA/Concepto 410 -Seguridad Social.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 410 no evaluado");
