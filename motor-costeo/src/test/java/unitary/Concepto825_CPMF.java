...
public class Concepto825_CPMF extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/environmentVars/p_cpmf.gdst;"+
											...
											"rules/costeo/BRA/Concepto 825 - CPMF.drl";
...
//		ksession.insert(new FactTarifa(34, "Preço Hora Extra"));
		...
		for (DetalleCosteo detalleCosteo : detallesCosteo) {
			...
			} else if (detalleCosteo.getCodigoConcepto()==825 && detalleCosteo.getDescripcion().equals("CPMF")) {
