...
public class Concepto455_IncidenciaCumulativa extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/environmentVars/p_cumulativa.gdst;" +
											...
											"rules/costeo/BRA/Concepto 455 - Incidencia Acumulativa.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 455 no evaluado");
