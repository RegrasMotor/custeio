...
public class Concepto745_AuxilioFuneral extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/environmentVars/v_auxfuneral.gdst;" +
											"rules/costeo/BRA/nivelCosteo.drl;" + 
											"rules/costeo/BRA/Concepto 745 - Auxilio funeral.drl";
    ...
    public void comprobarAccion() {
		...
		for (DetalleCosteo detalleCosteo : detallesCosteo) {
			if (detalleCosteo.getCodigoConcepto()==745) {
				if (detalleCosteo.getCodigoAgrupacion1().equals("VD") && detalleCosteo.getCodigoAgrupacion2().equals("SVIG - MG")) {
					assertEquals("Aux. funeral - SVIG - MG/VD", detalleCosteo.getDescripcion());
					...
					assertEquals("Aux. funeral - SVIG - MG/IN V1", detalleCosteo.getDescripcion());
