...
public class Concepto510_ValeTransporte extends JUnitBase {
	private final static String rulesFile = 
											"rules/costeo/BRA/functions/cantidadPersonasPorDia.function;" +
											"rules/costeo/BRA/functions/numeroDiasTrabajadosByEsquema.function";
//											"rules/costeo/BRA/functions/numeroDiasFrestivosServicio.function";
//											"rules/costeo/BRA/Dias trabajados por semana.drl;" +
//											"rules/costeo/BRA/Numero de meses de duracion del servicio.drl;" +
//											"rules/costeo/BRA/Numero Turnos Mes.drl";




//			"rules/costeo/BRA/functions/SumAcumuladores_510.function;" +
//											"rules/costeo/BRA/functions/PropVacaciones.function;" +
//											"rules/costeo/BRA/nivelCosteo.drl;" + 
//											"rules/costeo/BRA/Concepto 510 - Vale transporte.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 510 no evaluado");
