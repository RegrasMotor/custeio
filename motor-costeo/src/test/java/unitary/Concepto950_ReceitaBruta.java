...
//		ksession.insert(new FactTarifa(34, "Preço Hora Extra"));
		...
		assertEquals(17822.06+42.62, costeo.getAcumulador(Acum.TOTAL_IngresosBrutos), delta);
