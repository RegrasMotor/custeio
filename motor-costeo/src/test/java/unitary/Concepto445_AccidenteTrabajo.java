...
public class Concepto445_AccidenteTrabajo extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/environmentVars/p_accidente.gdst;" +
											...
											"rules/costeo/BRA/Concepto 445 - Accidente Trabajo.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 445 no evaluado");
