...
public class Concepto190_RiesgoVidaVSDF extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/environmentVars/p_arv_vsdf.gdst;" +
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 190 no evaluado");
