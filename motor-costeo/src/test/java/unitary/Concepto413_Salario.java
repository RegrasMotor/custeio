...
public class Concepto413_Salario extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/environmentVars/p_13salario.gdst;" +
											...
											"rules/costeo/BRA/Concepto 413 - Salario.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 413 no evaluado");
