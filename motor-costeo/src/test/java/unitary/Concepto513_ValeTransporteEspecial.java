...
public class Concepto513_ValeTransporteEspecial extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/nivelCosteo.drl;" + 
											"rules/costeo/BRA/Concepto 513 - Vale transporte especial.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 513 no evaluado");
