...
public class Concepto435_INCRA extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/environmentVars/p_incra.gdst;" +
											...
											"rules/costeo/BRA/Concepto 435 - INCRA.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 435 no evaluado");
