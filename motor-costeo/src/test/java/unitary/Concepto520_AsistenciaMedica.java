...
public class Concepto520_AsistenciaMedica extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/nivelCosteo.drl;" + 
											"rules/costeo/BRA/Concepto 520 - Asistencia medica.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 520 no evaluado");
