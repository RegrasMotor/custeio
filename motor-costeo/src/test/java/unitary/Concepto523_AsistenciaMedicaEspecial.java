...
public class Concepto523_AsistenciaMedicaEspecial extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/nivelCosteo.drl;" + 
											"rules/costeo/BRA/Concepto 523 - Asistencia medica especial.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 523 no evaluado");
