...
public class Concepto425_SENAC extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/environmentVars/p_senac.gdst;" +
											...
											"rules/costeo/BRA/Concepto 425 - SENAC.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 425 no evaluado");
