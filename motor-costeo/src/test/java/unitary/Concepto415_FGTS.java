...
public class Concepto415_FGTS extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/environmentVars/p_fgts.gdst;" +
											"rules/costeo/BRA/environmentVars/p_rvida_encargo.gdst;" +
											"rules/costeo/BRA/nivelCosteo.drl;" + 
											"rules/costeo/BRA/Concepto 415 - FGTS.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 415 no evaluado");
