...
public class Concepto416_Improdutividade extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/environmentVars/p_inden_impro.gdst;" +
											"rules/costeo/BRA/nivelCosteo.drl;" + 
											"rules/costeo/BRA/Concepto 416 - Improdutividade.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 416 no evaluado");
