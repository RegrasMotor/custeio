...
public class Concepto430_SEBRAE extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/environmentVars/p_sebrae.gdst;" +
											...
											"rules/costeo/BRA/Concepto 430 - SEBRAE.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 430 no evaluado");
