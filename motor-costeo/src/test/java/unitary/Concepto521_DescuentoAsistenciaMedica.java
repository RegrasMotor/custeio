...
public class Concepto521_DescuentoAsistenciaMedica extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/nivelCosteo.drl;" + 
											"rules/costeo/BRA/Concepto 521 - Descuento asistencia medica.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 521 no evaluado");
