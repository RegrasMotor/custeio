...
public class Concepto411_Festivos extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/environmentVars/p_ferias.gdst;" +
											...
											"rules/costeo/BRA/Concepto 411 - Festivos.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 411 no evaluado");
