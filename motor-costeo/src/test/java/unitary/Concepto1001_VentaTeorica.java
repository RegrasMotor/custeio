...
public class Concepto1001_VentaTeorica extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/functions/ventaTeorica.function;"+			
											"rules/costeo/BRA/nivelCosteo.drl;" + 
											"rules/costeo/BRA/Concepto 1001 - Venta teorica.drl";
...
//		ksession.insert(new FactTarifa(34, "Preço Hora Extra"));
		...
		System.out.println ("Concepto 1001 no evaluado");
