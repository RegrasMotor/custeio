...
public class Concepto525_AdicionalAsistenciaMedica extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/nivelCosteo.drl;" + 
											"rules/costeo/BRA/Concepto 525 - Adicional asistencia medica.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 525 no evaluado");
