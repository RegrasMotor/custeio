...
public class Concepto420_SESC extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/environmentVars/p_sesc.gdst;" +
											...
											"rules/costeo/BRA/Concepto 420 - SESC.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 420 no evaluado");
