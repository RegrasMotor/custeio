...
public class Concepto450_IncidenciaFGTS extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/environmentVars/p_in_fgts.gdst;" +
											...
											"rules/costeo/BRA/Concepto 450 - Incidencia sobre FGTS.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 450 no evaluado");
