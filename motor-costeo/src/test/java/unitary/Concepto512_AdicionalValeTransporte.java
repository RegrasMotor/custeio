...
public class Concepto512_AdicionalValeTransporte extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/nivelCosteo.drl;" + 
											"rules/costeo/BRA/Concepto 512 - Adicional Vale transporte.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 512 no evaluado");
