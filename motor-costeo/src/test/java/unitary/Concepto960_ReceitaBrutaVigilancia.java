...
public class Concepto960_ReceitaBrutaVigilancia extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/nivelCosteo.drl;" + 
											"rules/costeo/BRA/Concepto 950 - ReceitaBruta.drl;"+
											"rules/costeo/BRA/Concepto 960 - ReceitaBruta - Vigilancia Patrimonial.drl";
...
//		ksession.insert(new FactTarifa(34, "Preço Hora Extra"));
		...
		for (DetalleCosteo detalleCosteo : detallesCosteo) {
			...
			} else if (detalleCosteo.getCodigoConcepto()==960) {
				assertEquals("Receita Bruta - Vigilancia Patrimonial", detalleCosteo.getDescripcion());
