...
public class Concepto440_SalarioEducacion extends JUnitBase {
	private final static String rulesFile = "rules/costeo/BRA/environmentVars/p_seducacion.gdst;" +
											...
											"rules/costeo/BRA/Concepto 440 - Salario Educacion.drl";
    ...
    public void comprobarAccion() {
		...
		System.out.println ("Concepto 440 no evaluado");
